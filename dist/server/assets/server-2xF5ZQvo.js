...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C3UcSGSs.js");
...
const manifest = {
  ...
  "46015bd4db1c2f46c938c7ad7b7c5776656cc1e6a3578e90dfb8438d27bd97ae": {
    ...
    importer: () => import("./linkedin-analyzer.functions-CCGKtjhi.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DuIM60-q.js"),
    import("./start-Dk6yE2a-.js"),
